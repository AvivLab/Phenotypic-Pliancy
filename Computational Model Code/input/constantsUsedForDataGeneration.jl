...
const INDTRIALS = 10 # the number of different evolutionary trajectories for the same starting population
# ***update below***
...
const N = 1000 # population size, default 500, small 10 (N individuals) # use 1000 for paper
...
const RANDSEEDNUM = 1 # Number to use to set random seed for the starting population
...
# For measurements:
const SAVEDATA = (0,5,10,15,20,30,40,50,75,100,150,200,250,300,350,400,450,500,550,600,650,700,750,800,850,900,950,1000) # Generations to save population data
